export const ModelData=[
    {
        ...
        model:'',
        content:{
            0:"To be able to write data on or read data from a CD, you need a component called a CD drive. CD drives are often seen as a part of desktops or laptops, but can also be seen in some cars. There are also external CD drives which can be attached to computers that do not natively possess the component.",
            1:"CD drives work by placing the CDs in a pre-specified stencil and focussing a 780-nanometer laser onto the disc. This laser beam hits one particular track (groove) of the disc, and as the disc rotates, the CD drive is able to read more of it. The differences in the way the laser beam is reflected off the CD’s surface help the CD drive understand the data on it."
        }
    },
    {
        key:"printer",
    ...
    },
    {
        ...
        model:"",
        content:{
            0:"A modem and router are two of the most frequent components in a home network configuration. A router establishes a local area network (LAN), whereas a modem connects to an internet service provider (ISP). For a home network to work, both devices are necessary,Modem stands for Modulator/Demodulator. The modem is defined as a networking device that is used to connect devices connected in the network to the internet. The main function of a modem is to convert the analog signals that come from telephone wire into a digital form. In digital form, these converted signals are stored in the form of 0s and 1s. The modem can perform both the task of modulation and demodulation simultaneously. Modems are majorly used to transfer digital data in personal systems. The modem is also known as a signal translator as it translates one signal into another signal by modulating the digital signal into an analog signal for transmission and then demodulates receiving analog signals into digital signals."
    ...
    },
    {
        ...
        model:"",
        content:{
            0:"A barcode reader or barcode scanner is an optical scanner that can read printed barcodes, decode the data contained in the barcode on a computer. Like a flatbed scanner, it consists of a light source, a lens, and a light sensor for translating optical impulses into electrical signals."
        }
    },
    {
        key:"mouse",
    ...
    },
    {
        ...
        model:"",
        content:{
            0:"Biometric identifiers are often categorized as physiological characteristics which are related to the shape of the body. Examples include, but are not limited to fingerprint, palm veins, face recognition, DNA, palm print, hand geometry, iris recognition, retina, odor/scent, voice, shape of ears and gait."
        }
    },
    {
        key:"projector",
        ...
        model:"",
        content:{
            0:"A projector is an output device that is capable of connecting to a computer, which may be an other option for a monitor or television in terms of displaying pictures to a large number of people. It takes images generated by a Blu-ray player or a computer and projects them onto a large surface like a wall or white screen. Projectors come in many shapes and sizes and are used in conditions like a classroom, home cinemas, office training or presentation sessions, etc. The projector looks like the below picture."
    ...
    },
    {
        ...
        model:"",
        content:{
            0:"camera, in photography, device for recording an image of an object on a light-sensitive surface; it is essentially a light-tight box with an aperture to admit light focused onto a sensitized film or plate."
    ...
    
    {
        ...
        model:"",
        content:{
            0:"A smartphone is a cellular telephone with an integrated computer and other features not originally associated with telephones, such as an operating system (OS), web browsing and the ability to run software applications. Smartphones are used by consumers and as part of a person's business or work."
        }
    },
